...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('assets/app-assets/css-rtl/dashboard-analytics.css') }}">
    <!-- END: Theme CSS-->
...
<body class="vertical-layout vertical-menu-modern semi-dark-layout 2-columns  navbar-sticky footer-static  "
                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i
                            ...
                            <div class="search-input">
                                ...
                                <input class="input" type="text" placeholder="ابحث ..." tabindex="-1"
                            ...
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                <li class="dropdown-menu-header">
                                    <div class="dropdown-header px-1 py-75 d-flex justify-content-between"><span
                                            class="notification-title"> <b>7 إشعارات جديدة</b> </span><span
                                            class="text-bold-400 cursor-pointer">تحديد الكل كمقروء </span></div>
                                </li>
                                <li class="scrollable-container media-list"><a class="d-flex justify-content-between"
                                            ...
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0">
                                                    @if (isset(Auth::user()->profile->avatar))
                                                        <img src="{{ asset('images/' . Auth::user()->profile->avatar) }}"
                                                            class="rounde" alt="avatar" height="39" width="39">
                                                    @else
                                                        <img src="{{ url('assets/web/images/avatar.jpg') }}"
                                                            alt="users avatar" class="rounde" height="39"
                                                            width="39">
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="media-heading"><span class="text-bold-500">مرحبًا بك
                                                        {{ Auth::user()->first_name }}</span> في بوابة الدفع الأولى
                                                    في اليمن Wasl Pay &#127881 !</h6><small
                                                    class="notification-text">{{ Auth::user()->created_at }}</small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <div class="media-body">
                                                <h6 class="media-heading"><span class="text-bold-500"> <b> أشخاص قد
                                                            تعرفهم</b> </span>انضموا إلى بوابة الدفع "وصل" </h6><small
                                                    class="notification-text">استكشف 25 شخص قد تعرفهم من هنا</small>
                                            </div>
                                        </div>
                                    </a><a class="d-flex justify-content-between cursor-pointer"
                                        href="javascript:void(0);">
                                        <div class="media d-flex align-items-center py-0">
                                            <div class="media-left pr-0"><img class="mr-1"
                                                    src="{{ url('assets/app-assets/images/icon/sketch-mac-icon.png') }}"
                                                    alt="avatar" height="39" width="39"></div>
                                            <div class="media-body">
                                                <h6 class="media-heading"><span class="text-bold-500"> <b> تحديثات
                                                            جديدة </b> </span></h6><small class="notification-text">موقع
                                                    <b> مزاد </b> يعرض سيارة Kia Soul للبيع بسعر 2000$ </small>
                                            </div>
                                            <div class="media-right pl-0 mx-50">
                                                <div class="row border-left text-center">
                                                    <div class="col-12 px-10 py-75 border-bottom">
                                                        <h6 class="media-heading text-bold-500 mb-0"> <b> <a
                                                                    href="#mazad.com"> تفاصيل </a></b> </h6>
                                                    </div>
                                                    <div class="col-12 px-10 py-75">
                                                        <h6 class="media-heading mb-0"><a href="#"
                                                                style="color:#556b85"> إغلاق </a></h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="media d-flex align-items-center">
                                            <div class="media-left pr-0">
                                                <div class="avatar mr-1 m-0"><img
                                                        src="{{ url('assets/app-assets/images/portrait/small/avatar-s-16.jpg') }}"
                                                        alt="avatar" height="39" width="39"></div>
                                            </div>
                                            <div class="media-body">
                                                <h6 class="media-heading"><span class="text-bold-500"> <b> تم تحويل
                                                            مبلغ 100$ إلى حسابك </b> </span> من حساب Abdulrahman </h6>
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                                ...
                                <span>
                                    @if (isset(Auth::user()->profile->avatar))
                                        <img src="{{ asset('images/' . Auth::user()->profile->avatar) }}"
                                            alt="users avatar" class="round" height="40" width="40">
                                    @else
                                        <img src="{{ url('assets/web/images/avatar.jpg') }}" alt="users avatar"
                            ...
                            <div class="dropdown-menu dropdown-menu-right pb-0">
                                ...
                                <div class="dropdown-divider mb-0"></div><a class="dropdown-item"
                                    href="{{ route('logout') }}"><i class="bx bx-power-off mr-50"></i> تسجيل الخروج
                                </a>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true" id="main-menu">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main menu" id="main-menu-navigation" data-menu="menu-navigation"
                ...
                <li class=" nav-item"><a href="#"> <i class="fas fa-desktop"> </i><span
                            class="menu-title text-truncate" data-i18n="Dashboard">لوحة التحكم</span></a>
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="#"><span class="menu-item text-truncate"
                                    data-i18n="eCommerce"> رصيدك الحالي</span> <span
                                    class="badge badge-light-success badge-pill badge-round float-right mr-50 ml-auto">
                ...
                <li class="@yield('home')"><a class="d-flex align-items-center"
                        href="{{ route('customer_dashboard') }}"><i class="bx bx-right-arrow-alt"></i><span
                            class="menu-item text-truncate" data-i18n="Analytics">عرض الإحصائيات</span></a>
                </li>
                <li class="@yield('addBalance') nav-item"><a href="{{ route('addBalance') }}"> <i
                            class="fas fa-plus"></i> <span class="menu-title text-truncate"
                            data-i18n="Colors">إضافة رصيد</span></a>
                </li>
                <li class="@yield('transaction') nav-item"><a href="{{ route('transaction') }}"> <i
                            class="fas fa-file-invoice-dollar"></i> <span class="menu-title text-truncate"
                            data-i18n="Colors">العمليات</span></a>
                </li>

                <li class="@yield('transfer') nav-item"><a href="{{ route('transfer') }}"> <i
                            class="fas fa-exchange-alt"></i> <span class="menu-title text-truncate"
                            data-i18n="Card">تحويل رصيد</span></a>
                </li>
                <li class="@yield('settings') nav-item"><a href="{{ route('settings') }}"> <i
                            class="fas fa-gear">  </i> <span class="menu-title text-truncate" data-i18n="Widgets">
                            إعدادات الحساب</span></a>
                </li>

                <li class=" navigation-header text-truncat divider"><span data-i18n="Forms &amp; Tables"> </span>
                </li>
                <li class="@yield('report') nav-item"><a href="{{ route('report') }}"><i
                            class="fas fa-bug"></i> <span class="menu-title text-truncate"
                            data-i18n="Form Layout"> <button> </button type="button" class="btn btn-primary"
                                data-toggle="modal" data-target="#exampleModal"> الإبلاغ عن مشكلة</span></a>
                </li>
                <li class="@yield('active') nav-item"><a href="{{ route('index') }}"> <i
                            class="fas fa-house"></i> <span class="menu-title text-truncate" data-i18n="Email">
                            الرئيسية - Home</span></a>
                </li>
        </div>
    </div>
    <!-- END: Main Menu-->
    ...
    <footer class="footer footer-static footer-light">
        <p class="clearfix mb-0"><span class="float-left d-inline-block">2022 &copy; Wasl Team</span><span
                class="float-right d-sm-inline-block d-none">Made with<i
                    class="bx bxs-heart pink mx-50 font-small-3"></i>by<a class="text-uppercase" href="#WaslTeam.com"
                    target="_blank"> Wasl Team</a></span>
