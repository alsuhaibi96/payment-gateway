...
@section('content')
                ...
                <li class="active nav-item"><a href="{{ route('withdraw') }}"> <i class="fas fa-circle-minus">  </i> <span class="menu-title text-truncate" data-i18n="Icons">سحب رصيد </span></a>
                </li>
                            ...
                            <div class="card">
                                <div class="card-body pb-0 mx-25">
                                    ...
                                    <div class="row mx-0">
                                        ...
                                        <div class="col-xl-6 col-md-12 d-flex align-items-center pl-0">
                                            <span class="text-success display-6"><b> 114k YER </b> </span>
                                        </div>
                                    </div>
                                    <hr>
                                    <!-- logo and title -->
                                    ...
                                    <div class="col-sm-6 col-12 order-1 order-sm-1 d-flex justify-content-start">
                                        <span class="text-dark"><b>المبلغ المسحوب </b> </span>
                                    </div>

                                    <div class="col-sm-6 col-12 order-1 order-sm-1 d-flex justify-content-start mb-2">
                                        <small class=" text-danger"> من الموقع إلى بطاقة الصرّاف </small>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 col-md-7 offset-lg-2 col-12">
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between border-0 pb-0">
                                                        <span class="invoice-subtotal-title">الرصيد المسحوب</span>
                                                    ...
                                                    <li class="list-group-item d-flex justify-content-between border-0 py-0">
                                                        ...
                                                        <h6 class="invoice-subtotal-value mb-0">89k </h6>
                                                    </li>
                                                    <li class="list-group-item d-flex justify-content-between border-0 pb-0">
