...
<body>
    ...
    <section class="login-form container justify-content-center pt-4 pb-4">
        ...
        <form class="login-form row container g-3" method="POST" action="{{ route('save_user') }}">
            @csrf


            <div class="col-md-6">
                <label for="inputEmail4" class="form-label">اسم المستخدم</label>
                <input placeholder="الاسم المستخدم" type="text" id="inputEmail4"
            ...
            <div class="col-md-6">
                ...
                <input placeholder="البريد الالكتروني" type="email" id="inputEmail4"
            ...
            <div class="col-md-6">
                ...
                <input placeholder="كلمة المرور " type="password" id="inputEmail4"
