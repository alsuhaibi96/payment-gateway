                                ...
                                <div class="card-body pb-0 mx-25">
                                        ...
                                        <a class="mr-2" href="javascript:void(0);">
                                            @if (isset(Auth::user()->profile->avatar))
                                                <img src="{{ asset('images/' . Auth::user()->profile->avatar) }}"
                                                    alt="users avatar" class="users-avatar-shadow rounded-circle w-2"
                                                    style="object-fit: cover;">
                                            @else
                                                <img src="{{ url('assets/web/images/avatar.jpg') }}" alt="users avatar"
                                                    class="users-avatar-shadow rounded-circle" style="object-fit: cover">
                                            @endif
                                        </a>
                                    ...
                                    <div class="col-12 px-0 d-flex mb-5">
                                        ...
                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#exampleModal"
                                            class="btn btn-sm btn-primary mr-25">تغيير</a>
                                        ...
                                        <div class="row">
                                            <div class="col-6 py-20">
                                                ...
                                                <input type="text" class="form-control"
                                                    placeholder="Mo'khtar Mohammed Ghaleb" name="first_name"
                                ...
                                <div class="invoice-subtotal pt-50">
                                    <div class="row">
                                        ...
                                        <li class="list-group-item border-0 pb-0">
                                            <button class="btn btn-primary btn-block subtotal-preview-btn">تحديث الملف
                                                الشخصي</button>
                                        </li>
                            ...
                            <form action="{{ route('update-password') }}" method="POST">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12 py-20 mb-2">
                                                ...
                                                <input name="old_password" type="password"
                                                    ...
                                                    id="oldPasswordInput" placeholder="كلمة السر الحالية">
                                                @error('old_password')
                                            ...
                                            <div class="col-12 py-20">
                                                <label for="newPasswordInput" class="text-dark"> أدخل كلمة المرور
                                                    الجديدة (حافظ على أمان حسابك. لا تستخدم اسمك.) </label>
                                                <input name="new_password" type="password"
                                                    class="form-control @error('new_password') is-invalid @enderror"
                                                    id="newPasswordInput" placeholder="كلمة السر الجديدة">
                                                @error('new_password')
                                                    <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="order-2 order-sm-1">
                                        <div class="row">
                                            <div class="col-12 py-20">
                                                <label for="confirmNewPasswordInput" class="text-dark">قم بتأكيد كلمة
                                                    مرورك الجديدة </label>
                                ...
                                <div class="card-body pt-50">
                                    ...
                                    <div class="invoice-subtotal pt-50">
                                        <div class="row">
                                            ...
                                            <li class="list-group-item border-0 pb-0">
                                                <button type="submit"
                                                    class="btn btn-primary btn-block subtotal-preview-btn">تغيير كلمة
                                                    السر</button>
                                            </li>
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-md-8 col-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-50">
                            <div class="col-12 py-20">
                                <p>أضف طبقة أمان إضافية إلى حسابك باستخدام رمز أمان يُستخدم لمرة واحدة بالإضافة إلى كلمة
                                    المرور الخاصة بك في كل مرة تقوم فيها بتسجيل الدخول.</p>
                            </div>
                            <div class="col-3">
