                ...
                <div class="mt-auto mb-auto w-px flex lg:space-x-2/12 lg:flex-row md:flex-col flex-col w-px sm:w-full relative z-40" style="width: 920px;">
                    <div class="flex-1 mx-0 my-0 w-full md:w-1/2 md:mx-auto relative">
                        <div class="flex flex-row space-x-8 md:space-x-0">
                            <div class="flex flex-1 md:w-max-content md:flex-none my-auto"><button href="https://storelm.com/ar/cancelation" class="flex items-center focus:outline-none"><svg id="Capa_1" version="1.1" viewBox="0 0 31.494 31.494" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" y="0px" class="fill-current text-black w-4">
                                  ...
                                  c-0.444,0.444-1.143,0.444-1.587,0l-9.952-9.952c-0.429-0.429-0.429-1.143,0-1.571L10.273,5.009z"></path>
                                    </svg><img src="https://merchant.thawani.om/logos/1635661883nma1g0xz.jy2.jpeg" alt="" class="ml-2 w-6 h-6 rounded-full"><span class="text-sm truncate relative left-3">Wasl Payment</span></button></div>
                        ...
                        <div>
                            ...
                            <span dir="rtl">
                                <form action="{{ route('Payment_confirmation')}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-5">
                                        <fieldset>
                                            <legend class="block text-sm font-medium leading-5 text-gray-700">بيانات البطاقة </legend>
                                            <div class="mt-1 bg-white rounded-md shadow-sm relative"><span>
                                                    <p id="email-error" class="absolute bottom-20 right-0 text-xs text-red-600 text-right normal-case"> </p>
                                                    <div class="relative">
                                                        <input id="card_number" type="text" autocomplete="off" value="{{ old('card_number') }}" placeholder="رقم البطاقة" class="form-input relative block w-full rounded-none rounded-t-md bg-transparent focus:z-10 transition ease-in-out duration-150 sm:text-sm sm:leading-5" maxlength="16" name="card_number">
                                                ...
                                                <div class="-mt-px flex">
                                                    <div class="w-1/2 flex-1 min-w-0 relative"><span>
                                                            ...
                                                            @endif
                                                            <p id="date-error" class="absolute left-0 text-xs text-red-600 text-right normal-case"> </p>
                                                        </span></div>
                                                    ...
                                                    <div class="-ml-px flex-1 min-w-0"><span>
                                                            ...
                                                            <p id="cvv-error" class="absolute right-0 text-xs text-red-600 text-right normal-case"> </p>
                                                        </span></div>
                                                </div>
                                            </div>
                                        </fieldset>
                                    ...
                                    <div class="mt-10"><label for="holder" class="block text-sm font-medium leading-5 text-gray-700">الاسم على البطاقة</label>
                                        <div class="mt-1 relative rounded-md shadow-sm relative"><span>
                                                ...
                                                <p id="holder-error" class="absolute bottom-10 right-0 text-xs text-red-600 text-right normal-case"> </p>
                                            </span></div>
                                    </div>
                                    <!---->
                                    ...
                                    @foreach ($invoice_data as $item )
                                    <div class="mt-7 md:mb-0"><span class="block w-full rounded-md shadow-sm"><button type="submit" class="w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md transition duration-150 ease-in-out text-white  bg-green-500 hover:bg-green-400 focus:outline-none focus:bg-green-600 focus:shadow-outline-green active:bg-green-600"><span> {{ $item->total_amout .' $' }}</span>
                                        @endforeach       
                                        <svg fill="none" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" style="display: none;">
                                                ...
                                                </svg><span style="display: none;"> Processing </span><svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="-ml-1 mr-3 h-5 w-5 text-white fill-current" style="display: none;">
            ...
            <div class="fixed z-50 inset-0 overflow-y-auto" style="display: none;">
                <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div aria-labelledby="modal-headline" aria-modal="true" role="dialog" class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left shadow-xl overflow-hidden transform transition-all sm:my-8 sm:align-middle w-full sm:max-w-md sm:w-full sm:p-6">
                        <div class="sm:block absolute top-0 right-0 pt-4 pr-4"><button aria-label="Close" type="button" class="text-gray-400 hover:text-gray-500 focus:outline-none focus:text-gray-500 transition ease-in-out duration-150"><svg fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="h-6 w-6">
