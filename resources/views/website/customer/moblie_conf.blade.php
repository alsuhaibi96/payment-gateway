...
<body>
    ...
    <section class="login-form container justify-content-center pt-4 pb-4  ">
      <div class="row section-header text-center p-4">
        <div class="col-12">
            <h2>أولاً ، أضف رقم هاتفك المحمول</h2>
        </div>
      </div>
      <form class="login-form row container g-3s text-center"  >
         ...
         <div class="row">
          ...
          <div class="mb-3 ">
            <label for="name" class="form-label fs-3">ادخل رقمك</label>
            <input name="phone" placeholder="رقم هاتفك" type="text" class="form-control fs-3 ">
