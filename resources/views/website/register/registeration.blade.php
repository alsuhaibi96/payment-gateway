...
@section('content')
<section class=" mt-5" style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%);width: 100%;height: 70%;line-height: 70%;">
    <!--Sign in form for speciftying if merchant or customer-->
<form action="{{ route('Signin') }}" method="POST" style=" " class="p-3">
    @csrf
    <div class="mt-5" style="border-radius:10px">
        <div class="up-card my-0 mt-5 my-sm-30 border-2  m-auto" style="border-radius:10px;" data-v-e9c818fa="">
            <div class="text-center card mt-5 col-5 m-auto pt-5" style="width:100%;" data-v-e9c818fa="">
                    ...
                    <fieldset data-v-e9c818fa="">
                        <div class="row card-body p-5 " data-v-e9c818fa="">
                            <div class="col-12 col-md-5 mt-10 col-md-offset-1 card mx-4 p-3 " data-v-e9c818fa="">
                                <div data-cy="button-box" class="up-button-box up-button-box-radio" data-v-e9c818fa="">
                                    <div class="up-radio"><label class="up-checkbox-label">
                                            <input id="client_radio" type="radio" checked value="1" name="radio1" aria-labelledby="button-box-1" value="hire"> <span class="up-checkbox-replacement-helper">
                                                <!---->
                                                <!---->
                                            </span> </label></div>
                            ...
                            <div class="col-12 col-md-5 mt-10 card mx-2  p-3" data-v-e9c818fa="">
                                <div data-cy="button-box" class="up-button-box up-button-box-radio" data-v-e9c818fa="">
                                    <div class="up-radio"><label class="up-checkbox-label">
                                            <input name="radio1" value="2" id="freelancer_radio" type="radio" aria-labelledby="button-box-2" value="work"> <span class="up-checkbox-replacement-helper">
                                                <!---->
                                                <!---->
                                            </span> </label></div>
