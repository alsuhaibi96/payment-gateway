                            ...
                            <div class="col-xl-9 col-md-8 col-12">
                                <div class="card">
                                    ...
                                    <div class="col-12 px-0 d-flex mb-5">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route("merchant_edit_image") }}" method="post" enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="card-body">
                                     ...
                                     <div class="row mb-2">
                                        <div class="col-sm-6 col-12 order-1 order-sm-1 d-flex justify-content-start">
                                            <span class="text-dark"><b> تعديل
                                                 الملف الشخصي </b> </span>
                                        </div>
                                    </div>


                                        <form action="{{ route('edit_merchant_profile') }}" method="post">
                                            @csrf
                                        <div class=" order-2 order-sm-1">
                                            <div class="row">
                                                <div class="col-6 py-20">
                                                     <label class="text-dark">الاسم الاول </label>
                                                     <input type="text" class="form-control" placeholder="الاسم الاول"name="first_name" value="{{Auth::user()->first_name }}" >
                                                </div>
                                                <div class="col-6 py-20">
...
<div class=" order-2 order-sm-1">
    <div class="row">
        ...
        <div class="col-6 py-20">
            <label class="text-dark">اسم المؤسسة </label>
      
        <input type="text" class="form-control" name="merchant_name" placeholder=" اسم المؤسسة"  
        value="{{ isset(Auth::user()->profile->merchant_name)?Auth::user()->profile->merchant_name:"" }}">
